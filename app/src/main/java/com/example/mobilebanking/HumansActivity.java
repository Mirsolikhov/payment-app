...
import com.example.mobilebanking.databinding.ActivityHumansBinding;
...
public class HumansActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityHumansBinding.inflate(getLayoutInflater());
        ...
        pay_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (number.equals("")||count_paying.equals(""))
                    Toast.makeText(HumansActivity.this, "Поля должны быть заполнены", Toast.LENGTH_SHORT).show();
                else
                    Toast.makeText(HumansActivity.this, "Оплата проведена успешно", Toast.LENGTH_SHORT).show();
            }
        });
    }
}